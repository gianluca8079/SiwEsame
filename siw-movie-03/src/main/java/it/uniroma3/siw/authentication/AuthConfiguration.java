...
public class AuthConfiguration extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		.antMatchers(HttpMethod.GET, "/", "/index", "/login", "/register", "/css/**", "/images/**", "favicon.ico","/movie","/artist","/movie/**","/artist/**","/formSearchMovies","/formSearchByArtist","/foundMovies","/searchMoviesByArtist/**").permitAll()
